...
//           <Link isExternal href="https://twitter.com/FundPilot" className="text-default-900">
//             <img src="/twitter-icon.png" width={24} height={24} alt="Twitter" />
//           </Link>
//           <Link isExternal href="https://linkedin.com/company/FundPilot" className="text-default-900">
//             <img src="/linkedin-icon.png" width={24} height={24} alt="LinkedIn" />
//           </Link>
//           <Link isExternal href="mailto:contact@FundPilot.com" className="text-default-900">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
       ...
       <WhiteLogo/>
        ...
        <div className="flex space-x-4">
          <a href="https://github.com/FundPilot" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
            <FiGithub size={24} className="hover:text-blue-500" />
          </a>
          <a href="https://twitter.com/FundPilot" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
            <FiTwitter size={24} className="hover:text-blue-400" />
          </a>
          <a href="https://linkedin.com/company/FundPilot" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
